...
export default function HeadspaceScreen() {
  ...
  const [newType, setNewType] = useState<HeadspaceNode["type"]>("place");
        ...
        >
          ...
          <View style={styles.nodeContent}>
            <View style={styles.nodeHeader}>
              ...
              >
                <Feather
                  name={node.type === "image" ? "image" : node.type === "place" ? "map-pin" : "file-text"}
                  size={12}
                  color={
                    node.type === "image" ? "#a0d9e8" : node.type === "place" ? "#a89de8" : "#a0e8b2"
                  }
                />
                <Text
                  style={[
      ...
      >
        {rootNodes.length === 0 ? (
          <EmptyState
            ...
            subtitle="Document your inner world — places, images, and descriptions"
            action={{ label: "Add Entry", onPress: () => setShowAddModal(true) }}
          />
        ) : (
        ...
        <View style={[styles.modalOverlay, { backgroundColor: "#0009" }]}>
          ...
          >
            ...
            <View style={styles.typeRow}>
              {(["place", "image", "description"] as const).map((t) => (
                <TouchableOpacity
                  key={t}
                  style={[
                    styles.typeBtn,
                    {
                      ...
                      backgroundColor: newType === t ? colors.primary + "22" : colors.secondary,
                    },
                  ]}
                  onPress={() => setNewType(t)}
                >
                  <Text style={[styles.typeBtnText, { color: newType === t ? colors.primary : colors.foreground }]}>
                    {t}
                  </Text>
                </TouchableOpacity>
              ))}
            ...
            <TextInput
              ...
              placeholder="Name this place or entry..."
              placeholderTextColor={colors.mutedForeground}
            />

            <Text style={[styles.modalLabel, { color: colors.mutedForeground }]}>Description</Text>
            <TextInput
              style={[styles.modalTextarea, { color: colors.foreground, borderColor: colors.border, backgroundColor: colors.secondary }]}
              value={newContent}
              onChangeText={setNewContent}
              placeholder="Describe this place or scene..."
              placeholderTextColor={colors.mutedForeground}
              multiline
            />
...
const styles = StyleSheet.create({
  ...
  nodeDesc: { fontSize: 13, fontFamily: "Inter_400Regular", lineHeight: 18 },
  ...
  typeBtn: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 20, borderWidth: 1 },
